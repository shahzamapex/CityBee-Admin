...
export const entities: Entity[] = [
  {
    ...
    fields: [
      ...
      { name: 'google_place_id', label: 'Google Place ID', type: 'text', inForm: false },
      { name: 'nickname', label: 'Nickname', type: 'text' },
      { name: 'default_area', label: 'Default Area', type: 'text' },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'parent_id', label: 'Parent', type: 'uuid', inForm: false, lookups: [{ field: 'parent_id', table: 'categories', label: 'name' }] },
      { name: 'is_active', label: 'Active', type: 'boolean', inList: true, listPill: true },
    ],
  },
  {
    ...
    fields: [
      ...
      { name: 'state_region', label: 'State / Region', type: 'text', inForm: false },
      { name: 'country', label: 'Country', type: 'text', inForm: false },
      { name: 'postal_code', label: 'Postal Code', type: 'text', inForm: false },
      { name: 'google_place_id', label: 'Google Place ID', type: 'text', inForm: false },
      { name: 'external_ref', label: 'External Ref', type: 'text', inForm: false },
      { name: 'rejection_reason', label: 'Rejection Reason', type: 'textarea', inForm: false },
      { name: 'owner_id', label: 'Owner', type: 'uuid', inForm: false, lookups: [{ field: 'owner_id', table: 'users', label: 'name' }] },
    ...
    steps: [
      ...
      { title: 'Details', fields: ['description', 'opening_hours', 'rating', 'review_count', 'status', 'rejection_reason'] },
  ...
  },
  {
    ...
    steps: [
      { title: 'Offer', fields: ['title', 'business_id', 'badge_text', 'subtitle', 'coupon_code'] },
      { title: 'Discount', fields: ['discount_type', 'discount_value', 'category_tag', 'description', 'terms'] },
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'is_active', label: 'Active', type: 'boolean', inList: true, listPill: true },
      { name: 'selected_city_id', label: 'Selected City', type: 'uuid', inForm: false, lookups: [{ field: 'selected_city_id', table: 'cities', label: 'name' }] },
      { name: 'selected_location_name', label: 'Selected Location', type: 'text', inList: false },
      { name: 'selected_location_locality', label: 'Locality (Sel.)', type: 'text', inList: false },
      { name: 'selected_location_state', label: 'State (Sel.)', type: 'text', inList: false },
      { name: 'selected_location_country', label: 'Country (Sel.)', type: 'text', inList: false },
      { name: 'selected_location_lat', label: 'Lat (Sel.)', type: 'number', inList: false, inForm: false },
      { name: 'selected_location_lng', label: 'Lng (Sel.)', type: 'number', inList: false, inForm: false },
      { name: 'selected_location_google_place_id', label: 'Place ID (Sel.)', type: 'text', inList: false, inForm: false },
    ],
  },
  {
    key: 'reviews',
  ...
  },
  {
    ...
    fields: [
      ...
      { name: 'reviewed_at', label: 'Reviewed At', type: 'text', inForm: false },
      { name: 'submitted_at', label: 'Submitted At', type: 'text', inForm: false },
      { name: 'rejection_reason', label: 'Rejection Reason', type: 'textarea', inForm: false },
      { name: 'submitter_user_id', label: 'Submitter User', type: 'uuid', inForm: false, lookups: [{ field: 'submitter_user_id', table: 'users', label: 'name' }] },
      { name: 'city_lat', label: 'City Lat', type: 'number', inList: false, inForm: false },
      { name: 'city_lng', label: 'City Lng', type: 'number', inList: false, inForm: false },
      { name: 'city_place_id', label: 'City Place ID', type: 'text', inList: false, inForm: false },
      { name: 'biz_lat', label: 'Biz Lat', type: 'number', inList: false, inForm: false },
      { name: 'biz_lng', label: 'Biz Lng', type: 'number', inList: false, inForm: false },
      { name: 'biz_place_id', label: 'Biz Place ID', type: 'text', inList: false, inForm: false },
